      ...
      <Content>
        ...
        {state.transactionFailure && !state.transactionSuccess && (
          <Presentation>
            ...
            <p>
              Someone should probably have a stern talking to about this, but it
              won't be me - coz I'm gonna head out into the nice weather
            </p>
            <Submit
              dirty
              onClick={() => {
            ...
            validate={({ email, password, verifiedPassword }) => {
              ...
              if (passwordVerification && !verifiedPassword) {
                errors.verifiedPassword =
                  errorMap.verifiedPassword.required.normal;
                errors.verifiedPasswordTooltip =
                  errorMap.verifiedPassword.required.tooltip;
              } else if (
                passwordVerification &&
                password !== verifiedPassword
              ) {
                errors.verifiedPassword =
                  errorMap.verifiedPassword.match.normal;
                errors.verifiedPasswordTooltip =
                  errorMap.verifiedPassword.match.tooltip;
              }
                ...
                >
                  <FieldWrapper>
                    ...
                    <FormikInput id="email" name="email">
                      {({
                        ...
                        field: HTMLAttributes<HTMLInputElement>;
                      }) => (
                        <>
                          <Input
                            data-testid="email"
                  ...
                  <FieldWrapper>
                    ...
                    {errors.password && (
                      <WithTooltip
                        tooltip={
                          <ErrorTooltip>{errors.passwordTooltip}</ErrorTooltip>
                        }
                      >
                      ...
                      >
                        {({
                          ...
                          <Input
                            ...
                            aria-disabled={isSubmitting ? 'true' : 'false'}
                            aria-invalid={
                              errors.verifiedPassword ? 'true' : 'false'
                            }
                            type="password"
                            disabled={isSubmitting}
                            {...field}
