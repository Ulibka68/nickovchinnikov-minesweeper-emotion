...
export const StandardEmailFilled = {
  ...Standard,
  play: () =>
    userEvent.type(screen.getByTestId('email'), 'michael@chromatic.com'),
};
...
export const StandardEmailFailed = {
  ...
  play: async () => {
    await userEvent.type(
      ...
      'michael@chromatic.com.com@com'
    );
    await userEvent.type(
      screen.getByTestId('password1'),
      'testpasswordthatwontfail'
    );
...
export const VerificationSuccess = {
  ...
  play: async () => {
    ...
    await sleep(1000);
    await userEvent.type(screen.getByTestId('password2'), 'asdfasdf', {
      delay: 50,
    });
    await sleep(1000);
    await userEvent.click(screen.getByTestId('submit'));
